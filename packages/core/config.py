# File: offline-avatar/packages/core/config.py
...
@dataclass
class ASRConfig:
    model_size: str = "assets/faster-whisper-small"
    device: str = "cpu"
...
@dataclass
class AvatarConfig:
    default_asset: str = "assets/avatars/P1_4nURxeVKvzaVTealb-UJg.zip"
...
_DEFAULTS: dict[str, Any] = {
    ...
    "asr": {"model_size": "assets/faster-whisper-small", "device": "cpu", "compute_type": "int8", "device_index": 0},
    "tts": {"rate": 185, "volume": 1.0},
    "avatar": {
        "default_asset": "assets/avatars/P1_4nURxeVKvzaVTealb-UJg.zip",
