...
batch_size=1
frontend_conf={'fs':16000,'frame_length':25,'frame_shift':10,'window':'hamming','n_mels': 80, 'lfr_m': 7, 'lfr_n': 6}
token_num_relax=None
decoding_ind=None
decoding_mode=None
num_workers=0
device_env = (os.environ.get("LITE_AVATAR_ASR_DEVICE", "cpu") or "cpu").strip().lower()
device = "cuda" if device_env.startswith("cuda") and torch.cuda.is_available() else "cpu"
